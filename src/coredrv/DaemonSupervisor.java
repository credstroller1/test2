...
final public class DaemonSupervisor {
	...
	final String CONFIG_NAME="newtest.conf"; 
...
//		else if (OSName.indexOf("sunos") >= 0) OS=OSType.SOLARIS;
		...
		switch (OS) {
			case WINDOWS: DAEMON_NAME="newtestd.exe"; DEFAULT_DIR="newtest"; break;
			case UNIX: DAEMON_NAME="newtestd"; DEFAULT_DIR=".newtest"; break;
			default: DAEMON_NAME="newtestd.bin"; DEFAULT_DIR="newtest"; break; // FIXME
		}
